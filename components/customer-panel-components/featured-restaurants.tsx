...
// Parent container variants for staggered card animations
          ...
          {featuredRestaurants.map((restaurant) => (
            <Link key={restaurant.id} href="/restaurants">
              <motion.div variants={itemVariants}>
                <Card className="group cursor-pointer bg-white rounded-2xl border-secondary/50 transform hover:-translate-y-1 overflow-hidden transition-all duration-300">
